...
## Material Bibata Noir

Derived from the `Bibata-Material-Noir` XCursor theme in the Material Bibata Cursor 1.0.0 archive. The archive names
Sakib Shahariar as its source author and references `github.com/SakibShahariar/bibata-material`, but did not include a
license file. Redistribution permission must be confirmed with the upstream author before a public release.

## Noir and Noir White

Derived from the Noir 1.1 XCursor archive. The downloaded archive did not include an author or license file.
