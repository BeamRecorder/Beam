...
contextBridge.exposeInMainWorld(
  ...
  Object.freeze({
    ...
    startCameraPreview: (cameraId) => invoke("camera-preview-start", { cameraId }),
    stopCameraPreview: () => invoke("camera-preview-stop"),
    startAudioLevelMonitor: (sourceId) => invoke("audio-level-start", { source: sourceId }),
    readAudioLevelMonitor: (monitorId) => invoke("audio-level-read", { monitor: monitorId }),
    stopAudioLevelMonitor: (monitorId) => invoke("audio-level-stop", { monitor: monitorId }),
