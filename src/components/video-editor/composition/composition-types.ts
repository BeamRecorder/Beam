...
export interface MediaCompositionLayer extends CompositionLayerBase { kind: CompositionMediaKind; assetId: string; transform?: NormalizedTransform; sourceOffsetMs?: number; reactToZoom?: boolean; webcamAppearance?: WebcamAppearance; appearance?: ClipAppearance }
