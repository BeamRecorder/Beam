...
export interface CompositionMedia { id: string; kind: CompositionMediaKind; name: string; fileName: string; durationMs: number; width: number | null; height: number | null; src: string }
...
export interface MediaCompositionLayer extends CompositionLayerBase { kind: CompositionMediaKind; assetId: string; transform?: NormalizedTransform }
