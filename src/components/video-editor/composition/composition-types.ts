...
export interface ClipAppearance extends WebcamAppearance { shadowColor: string; shadowDirection: 'all' | 'bottom' | 'bottom-right' | 'top-left' }
...
export interface MediaCompositionLayer extends CompositionLayerBase { kind: CompositionMediaKind; assetId: string; transform?: NormalizedTransform; crop?: NormalizedCrop; sourceOffsetMs?: number; reactToZoom?: boolean; webcamAppearance?: WebcamAppearance; appearance?: ClipAppearance }
...
export interface ProjectComposition { media: CompositionMedia[]; layers: CompositionLayer[]; baseVideoAppearance?: ClipAppearance }
