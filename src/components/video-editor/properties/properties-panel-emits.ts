...
import type { CursorClickEffects, CursorMotionSettings, CursorAutoHideSettings } from '~/api/types/cursor-settings';
import type {
  CaptionClip,
  ClipComposition,
  BlurEffectMode,
...
import type { CameraLayoutPreset, CameraFramingPreset } from '~/media/shared/camera-layout-types';
...
export interface PropertiesPanelEmits {
  ...
  (event: 'start-recording', config: unknown): void;
}
