...
<template>
  <div class="properties-island">
    ...
    <div class="panel-content">
      ...
      <AudioClipPropertiesPanel v-else-if="activeTab === 'clip' && normalizedSelectedClip?.kind === 'audio'" :clip="normalizedSelectedClip" @update:volume="emit('update:clip-volume', $event)" @update:enabled="emit('update:clip-enabled', $event)" @unlink="emit('unlink-clip')" @delete="emit('delete-clip')" />
