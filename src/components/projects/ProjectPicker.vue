...
<template>
  <section class="project-picker" :class="{ compact }" aria-labelledby="project-picker-title">
    ...
    <div class="project-picker-body" :class="{ 'has-tools': isSearchOpen || isSelectionMode }">
      <Transition name="project-tools">
        <div v-show="isSelectionMode" :inert="isSelectionMode ? undefined : true" class="project-selection-bar">
      ...
      <Transition name="project-tools">
        <div v-show="isSearchOpen" :inert="isSearchOpen ? undefined : true" class="project-search-bar">
          <Input
                ...
                <div
                  ...
                  :class="{
                    'is-selected': isSelectionMode
                      ? selectedBatchIds.has(project.id)
