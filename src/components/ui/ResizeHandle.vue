...
.is-top { top: -5px; left: 50%; width: 22px; height: 10px; transform: translateX(-50%); cursor: ns-resize; }
.is-top-right { top: -7px; right: -7px; cursor: nesw-resize; }
.is-right { top: 50%; right: -5px; width: 10px; height: 22px; transform: translateY(-50%); cursor: ew-resize; }
.is-bottom-left { bottom: -7px; left: -7px; cursor: nesw-resize; }
.is-bottom { bottom: -5px; left: 50%; width: 22px; height: 10px; transform: translateX(-50%); cursor: ns-resize; }
.is-bottom-right { right: -7px; bottom: -7px; cursor: nwse-resize; }
.is-left { top: 50%; left: -5px; width: 10px; height: 22px; transform: translateY(-50%); cursor: ew-resize; }
</style>
