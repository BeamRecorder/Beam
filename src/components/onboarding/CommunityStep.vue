  ...
  <div class="community-step">
    ...
    <div class="community-cards-grid">
      ...
      <div class="card-item github-card">
        ...
        <Button variant="secondary" size="xs" :block="true" class="center-action-btn" @click="handleGitHub">
      ...
      <div class="card-item discord-card">
        ...
        <Button variant="secondary" size="xs" :block="true" class="center-action-btn" @click="handleDiscord">
    ...
    <div class="launch-cta-wrap">
      <Button variant="primary" size="md" class="launch-button" @click="handleComplete">
