export const vertexSource = `attribute vec2 a_position;
void main() {
  gl_Position = vec4(a_position, 0.0, 1.0);
}`;

export const fragmentSource = `#ifdef GL_FRAGMENT_PRECISION_HIGH
...
export const shaderPreset = {
  colors: [
    [0.09019607843137255, 0.08627450980392157, 0.07450980392156863],
    [0.9137254901960784, 0.29411764705882354, 0.0784313725490196],
    [1, 0.35294117647058826, 0.12156862745098039],
    [0.9568627450980393, 0.24705882352941178, 0.3686274509803922],
